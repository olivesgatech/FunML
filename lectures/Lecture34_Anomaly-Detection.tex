...
\begin{figure}[H]
    ...
    \caption{Figure 27.1: Example of anomalous structures within a structured material.}
...
\begin{figure}[H]
    ...
    \caption{Figure 27.2: Anomaly detection scenario in a public setting.}
...
\begin{figure}[H]
    ...
    \caption{Figure 27.3: Process of detecting anomalies in a time-series signal $x(t)$}
...
\begin{figure}[H]
    ...
    \caption{Figure 27.4: Threshold-based anomaly detection: an evolving statistic crosses the
...
\caption{Figure 27.5: Effect of the decision threshold on anomaly detection. Lower thresholds detect more anomalies but increase false positives, while higher thresholds reduce false positives but may miss anomalies.}
...
\begin{figure}[H]
    ...
    \caption{Figure 27.6: ROC curve comparison across anomaly detection methods.  
...
\begin{figure}[H]
    ...
    \caption{Figure 27.7: Distance-based anomaly detection: anomalies lie far from dense clusters.}
...
\begin{figure}[H]
    ...
    \caption{Figure 27.8: Isolation Forest: anomalies are isolated in fewer splits.}
...
\begin{figure}[H]
    ...
    \caption{Figure 27.9: Using a trained convolutional neural network for anomaly detection via softmax confidence.}
    \label{fig:msp}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Figure 27.10: Structure of an autoencoder used for reconstruction-based anomaly detection.}
