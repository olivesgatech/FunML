...
\lecture{5}{Classification IV: Neural Networks}{Ghassan AlRegib and Mohit Prabhushankar}{}

%%%%%CHANGE HERE%%%%%%%
%%%%%\section{title of the section} similarly with the rest \section{} or \subsection{} or \subsubsection{} etc

\noindent\textbf{Keywords:} Neural networks, backpropagation, gradient descent, perceptron, optimization, classification
...
\begin{figure}[h]
    ...
    \caption{Figure 5.1: Linearly Separable Graph}
...
\begin{figure}[h]
    ...
    \caption{Figure 5.2: \textit{Left}: Non-linear, Separable Graph; \textit{Right}: Non-Separable Graph}
    \label{fig:enter-label}
\end{figure}
...
\begin{minipage}{.5\textwidth}
  \centering
  \includegraphics[width=.9\linewidth]{img/lecture5/ffd_inpt_data.png}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
    \includegraphics[width=0.8\linewidth]{img/lecture5/back.png}
\end{minipage}
\end{figure}
