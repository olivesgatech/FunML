...
\lecture{11}{Clustering II: K-Means}{Ghassan AlRegib and Mohit Prabhushankar}{}

%%%%%CHANGE HERE%%%%%%%
%%%%%\section{title of the section} similarly with the rest \section{} or \subsection{} or \subsubsection{} etc

\noindent\textbf{Keywords:} Clustering, unsupervised learning, representation learning, K-Means, K-Medoids, K-Means++
...
\begin{figure}[H]
    ...
    \caption{Figure 11.1: k-Means Clustering Standard Algorithm Procedure}
...
\begin{figure}[H]
    ...
    \caption{Figure 11.2: Data Points}
    \label{fig:enter-label}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Figure 11.3: Initialized centroids}
    \label{fig:enter-label}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Figure 11.4: Assignment of all samples using Euclidean distance}
    \label{fig:enter-label}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Figure 11.5: centroids move the to the calculated mean of the clusters}
    \label{fig:enter-label}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Figure 11.6: Second iteration assignment cluster membership}
    \label{fig:enter-label}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Figure 11.7: second iteration update step: Re-estimate centroids}
    \label{fig:enter-label}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Figure 11.8: Third iteration assignment step}
    \label{fig:enter-label}
...
\begin{figure}[H]
    ...
    \caption{Figure 11.9: Figure 11.8: Third iteration update step}
    \label{fig:enter-label}
\end{figure}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Figure 11.10: Converged Algorithm, and final cluster assignment}
    \label{fig:enter-label}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Figure 11.11: Different choices of $k$ lead to different clustering results.}
    \label{fig:k-choice}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Figure 11.12: Different methods of initializing centroids can change the outcome.}
...
\begin{figure}[H]
    ...
    \caption{Figure 11.13: Sensitivity of k-means to outliers. Left: original dataset.
...
\begin{figure}[H]
    ...
    \caption{Figure 11.14: Mini-batch k-means reduces computation time by using small random
...
\begin{figure}[H]
    ...
    \caption{Figure 11.15: Comparison of clustering results from mini-batch k-means and
...
\begin{figure}[H]
    ...
    \caption{Figure 11.16: Dataset and graphical representation}
\end{figure}
...
\begin{enumerate}
    ...
    \begin{figure}[H]
        ...
        \caption{Figure 11.17: Initial assignment to clusters}
    \end{figure}
    ...
    \begin{enumerate}
        ...
        \begin{figure}[H]
            ...
            \caption{Figure 11.18: Computing alternate center costs}
        \end{figure}
        ...
        \begin{figure}[H]
            ...
            \caption{Figure 11.19: Clusters after updating $\mathbf{m}_1$}
        \end{figure}
        ...
        \begin{figure}[H]
            ...
            \caption{Figure 11.20: Computing alternate center costs}
        \end{figure}
        ...
        \begin{figure}[H]
            ...
            \caption{Figure 11.21: Clusters after updating $\mathbf{m}_2$}
        \end{figure}
    ...
    \begin{figure}[H]
        ...
        \caption{Figure 11.22: Re-assignment of all samples to clusters}
    \end{figure}
    ...
    \begin{enumerate}
        ...
        \begin{figure}[H]
            ...
            \caption{Figure 11.23: Computing alternate center costs}
        \end{figure}
        ...
        \begin{figure}[H]
            ...
            \caption{Figure 11.24: Clusters after updating $\mathbf{m}_1$}
        \end{figure}
        ...
        \begin{figure}[H]
            ...
            \caption{Figure 11.25: Computing alternate center costs}
        \end{figure}
        ...
        \begin{figure}[H]
            ...
            \caption{Figure 11.26: Clusters after updating $\mathbf{m}_2$}
        \end{figure}
