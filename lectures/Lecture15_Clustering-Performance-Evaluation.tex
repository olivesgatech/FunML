...
\lecture{12}{Clustering Performance Evaluation}{Ghassan AlRegib and Mohit Prabhushankar}{}%


\section{Lecture Objectives}

In the previous lecture we covered Gaussian Mixture Models and the EM algorithm for soft
clustering. In this lecture, we evaluate clustering quality using \textbf{internal} metrics
(e.g., Silhouette, Davies--Bouldin, Dunn Index) and \textbf{external} metrics
(e.g., Rand Index, Mutual Information, Purity). We also discuss extensions of clustering
including Mean Shift, Adjusted Rand Index (ARI), and image segmentation applications.
