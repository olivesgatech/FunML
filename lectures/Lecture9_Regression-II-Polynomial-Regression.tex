...
\lecture{8}{Regression II: Polynomial Regression}{Ghassan AlRegib and Mohit Prabhushankar}{}

\noindent\textbf{Keywords:} Polynomial regression, regression, gradient descent, convergence, contour plots 
...
\begin{figure}[h]
    ...
    \caption{Figure 8.1: Linear model in transformed feature space capturing nonlinear relationships}
\end{figure}
...
\begin{figure}[h]
    ...
    \caption{Figure 8.2: Nonlinear data generated from a quadratic function with noise and the fitted polynomial regression curve}
\end{figure}
...
\begin{figure} [h]
    ...
    \caption{Figure 8.3: The negative gradient (derivative)
...
\begin{figure}[H]
    ...
    \caption{Figure 8.4: Convergence path of Batch Gradient Descent}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Figure 8.5: Convergence path of Stochastic Gradient Descent}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Figure 8.6: Convergence path of Mini-batch Gradient Descent}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Figure 8.7: Visualization of Batch, Stochastic, and Mini-batch Gradient Descent convergence.}
    \label{fig:P1.png}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Figure 8.8: Different Gradient Descent methods converge toward the minimum but exhibit different trajectories}
\end{figure}
...
\caption{Figure 8.9: Linear vs Polynomial Regression fit on nonlinear data}
\end{figure}
...
\caption{Figure 8.10: Training MSE comparison}
\end{figure}
