...
\lecture{15}{Convolutional Neural Networks IV: Training}{Ghassan AlRegib and Mohit Prabhushankar}{}
...
\noindent\textbf{Keywords:} Convolutional neural networks, training dynamics, gradient descent, data augmentation, optimization
...
\begin{figure}[H]
    ...
    \caption{Figure 15.1: Example of a non-convex loss landscape with local minima and saddle points.}
...
\begin{figure}[H]
    ...
    \caption{Figure 15.2: Gradient descent and the effect of learning rate. Small learning rates lead to slow convergence, while large learning rates may cause overshooting or divergence.}
...
\begin{figure}[H]
    ...
    \caption{Figure 15.3: Batch Gradient Descent convergence path.}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Figure 15.4: Stochastic Gradient Descent convergence path.}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Figure 15.5: Mini-batch Gradient Descent convergence path.}
\end{figure}
...
\caption{Figure 15.6: Loss surfaces may contain many local minima and flat regions where gradient descent can slow down or stop, potentially leading to suboptimal solutions.}
...
\caption{Figure 15.7: At saddle points, gradients vanish even though better solutions exist in certain directions. This can significantly slow training.}
\label{fig:saddle_ex}
\end{figure}
...
\caption{Figure 15.8: When gradient decent is combined with the concept of momentum the optimization algorithm has a driving force even when the gradient at a given point is 0. This helps the algorithm overcome local minima and saddle points and continue towards the global solution, as seen in the image.}
...
\caption{Figure 15.9: An illustration of anisotropic curvature: the surface is much steeper in one direction than another, producing a narrow valley that slows gradient descent.}
...
\caption{Figure 15.10: AdaGrad adapts the learning rate to follow the optimal path in ill-conditioned problems, reducing oscillations compared to standard gradient descent.}
...
\caption{Figure 15.11: Comparison of optimization trajectories. RMSProp follows a similar path to AdaGrad but converges faster by preventing the learning rate from shrinking too aggressively.}
...
\begin{figure}[H]
    ...
    \caption{Figure 15.12: An example convolution of a $17 \times 17 \times 1$ image with a $3 \times 3$ edge-detection kernel.}
...
\begin{figure}[H]
    ...
    \caption{Figure 15.13: AlexNet architecture. An image of size $224\times224\times3$ is processed through multiple convolutional layers with progressively smaller filters.}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Figure 15.14: Filters from the first convolutional layer of AlexNet.}
...
\begin{figure}[H]
    ...
    \caption{Figure 15.15: Filters from the second and third convolutional layers of AlexNet showing more abstract patterns.}
...
\begin{figure}[H]
    ...
    \caption{Figure 15.16: Activation maps from the fifth convolutional layer of AlexNet. The highlighted filter responds strongly to wheels across multiple images.}
