...
\lecture{13}{Convolutional Neural Networks II: Introduction to CNNs}{Ghassan AlRegib and Mohit Prabhushankar}{}

\noindent\textbf{Keywords:} Convolutional neural networks, convolution, pooling, neural networks, classification
...
\begin{figure}[H]
    ...
    \caption{Figure 13.1: A fully connected neuron attached to every input pixel}
...
\begin{figure}[H]
    ...
    \caption{Figure 13.2: Neurons connected to local image patches}
...
\begin{figure}[H]
    ...
    \caption{Figure 13.3: Illustration of 2D discrete convolution as a sliding kernel operation}
...
\begin{figure}[H]
    ...
    \caption{Figure 13.4: Kernel positioned at $X[0,3]$}
...
\begin{figure}[H]
    ...
    \caption{Figure 13.5: Kernel positioned at $X[1,3]$}
...
\begin{figure}[H]
    ...
    \caption{Figure 13.6: Kernel positioned at $X[3,0]$}
...
\begin{figure}[H]
    ...
    \caption{Figure 13.7: Example of convolution: each output value is the sum of element-wise products between a $3\times3$ kernel and a local input patch.}
...
\begin{figure}[H]
    ...
    \caption{Figure 13.8: A $32\times32\times3$ RGB image convolved with a $5\times5\times3$ filter.}
    \label{fig:conv3d}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Figure 13.9: Six $5\times5\times3$ filters generate six $28\times28$ activation maps that are stacked to form a $28\times28\times6$ output volume.}
...
\begin{figure}[H]
    ...
    \caption{Figure 13.10: The $3\times3$ filter sliding across the first row of the $7\times7$ input.}
...
\begin{figure}[H]
    ...
    \caption{Figure 13.11: After traversing the first row, the output contains five columns.}
...
\begin{figure}[H]
    ...
    \caption{Figure 13.12: Final output size after the filter finishes traversing the input.}
...
\begin{figure}[H]
    ...
    \caption{Figure 13.13: With stride $S=2$, the filter skips positions along the first row, producing fewer output columns.}
...
\begin{figure}[H]
    ...
    \caption{Figure 13.14: Stride also applies vertically; skipping rows produces a $3\times3$ output feature map.}
...
\begin{figure}[H]
    ...
    \caption{Figure 13.15: Example calculations showing valid and invalid stride values.}
...
\begin{figure}[H]
    ...
    \caption{Figure 13.16: Based on kernel size $k$, the input is padded with $(k-1)/2$ zeros on each side to preserve spatial dimensions.}
...
\begin{figure}[H]
    ...
    \caption{Figure 13.17: Dimension variables for input, kernels, and output volumes.}
...
\begin{figure}[H]
    ...
    \caption{Figure 13.18: Receptive fields expand across layers: $Z_{1,1}$ has a $3\times3$ receptive field, while deeper units capture larger regions.}
...
\begin{figure}[H]
    ...
    \caption{Figure 13.19: End-to-end CNN pipeline illustrating convolution, activation, pooling, flattening, and fully-connected layers that transform raw images into final class predictions.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{img/lecture14/Im2.png}
    \caption{Figure 13.20: Common pooling operations used to downsample feature maps.}
    \label{fig:pooling_variants}
\end{figure}
