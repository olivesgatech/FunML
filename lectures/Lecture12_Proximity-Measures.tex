...
\lecture{10}{Clustering I: Proximity Measures}{Ghassan AlRegib and Mohit Prabhushankar}{}

\noindent\textbf{Keywords:} Clustering, K-means, unsupervised learning, representation learning, covariance, uncertainty
...
\begin{figure}[H]
    ...
    \caption{Figure 10.1: Illustration of key clustering terminology.}
...
\caption{Figure 10.2: Visualization of the running example points used throughout Section 10.2.}
...
\begin{figure}[H]
    ...
    \caption{Figure 10.3: Special cases of cosine similarity.}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Figure 10.4: Mahalanobis distance adapts to the covariance structure of the data.}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Figure 10.5: Samples from $\mathcal{N}(\mathbf{0},\Sigma_1)$. 
...
\begin{figure}[H]
    ...
    \caption{Figure 10.6: Samples from $\mathcal{N}(\mathbf{0},\Sigma_2)$. 
...
\begin{figure}[H]
    ...
    \caption{Figure 10.7: Samples from $\mathcal{N}(\mathbf{0},\Sigma_3)$. 
...
\begin{figure}[H]
    ...
    \caption{Figure 10.8: Samples from $\mathcal{N}(\mathbf{0},\Sigma_4)$. 
...
\begin{figure}[H]
    ...
    \caption{Figure 10.9: Samples from $\mathcal{N}(\mathbf{0},\Sigma_5)$. 
