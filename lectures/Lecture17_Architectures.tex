...
\lecture{14}{Convolutional Neural Networks III: Architectures}{Ghassan AlRegib and Mohit Prabhushankar}{}

\noindent\textbf{Keywords:} Convolutional neural networks, convolution, architectures, regularization, normalization, neural networks, classification
...
\begin{figure}[H]
    ...
    \caption{Figure 14.1: Timeline of major CNN architecture milestones.}
...
\begin{figure}[H]
    ...
    \caption{Figure 14.2: Notation and symbols used in CNN architecture diagrams throughout this lecture.}
    \label{fig:Evolution of CNNs}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Figure 14.3: LeNet-5 architecture, based on the original paper.}
...
\begin{figure}[H]
    ...
    \caption{Figure 14.4: Illustration of the vanishing gradient problem and its architectural solutions.}
...
\begin{figure}[H]
    ...
    \caption{Figure 14.5: AlexNet Architecture}
...
\begin{figure}[H]
    ...
    \caption{Figure 14.6: AlexNet Architecture}
...
\begin{figure}[H]
    ...
    \caption{Figure 14.7: Training and testing performance with and without dropout (CIFAR-10).}
...
\begin{figure}[H]
    ...
    \caption{Figure 14.8: Illustration of a neural network with randomly dropped units during training.}
...
\begin{figure}[H]
    ...
    \caption{Figure 14.9: Comparison of training dynamics using ReLU vs.\ tanh activation functions}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{img/lecture15/AlexNet5.png}
    \caption{Figure 14.13: Local Response Normalization in AlexNet}
    \label{fig:lrn-diagram}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{img/lecture15/AlexNet6_1.png}
    \caption{Figure 14.14: Inter-channel LRN vs. intra-channel normalization}
    \label{fig:lrn-example}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{img/lecture15/AlexNet6_2.png}
    \caption{Figure 14.15: Activations before and after applying LRN}
    \label{fig:lrn-normalization}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Figure 14.16: Yearly progress in ImageNet classification error rates showing the dramatic improvement achieved by AlexNet.}
...
\begin{figure}[H]
    ...
    \caption{Figure 14.17: Examples from the ImageNet dataset used in the ILSVRC challenge.}
...
\begin{figure}[H]
    ...
    \caption{Figure 14.18: VGG Architecture}
...
\begin{figure}[H]
    ...
    \caption{Figure 14.19: Yearly progress in ImageNet top-5 classification error rates.}
    \label{fig:VGG Error}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Figure 14.20: Comparison of CNN architectures showing the progression from AlexNet to VGG and deeper residual networks.}
    \label{fig:vgg-architecture}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Figure 14.21: GoogLeNet (Inception V1) architecture.}
...
\begin{figure}[H]
    ...
    \caption{Figure 14.22: Structure of an Inception Module in GoogLeNet.}
...
\begin{figure}[H]
    ...
    \caption{Figure 14.23: Illustration of the Batch Normalization process applied to activations within a mini-batch.}
...
\begin{figure}[H]
    ...
    \caption{Figure 14.24: ResNet Architecture}
...
\begin{figure}[H]
    ...
    \caption{Figure 14.25: Structure of a Residual Block}
...
\begin{figure}[H]
    ...
    \caption{Figure 14.26: Yearly progress in ImageNet top-5 classification error rates, highlighting the impact of ResNet.}
...
\begin{figure}[H]
    ...
    \caption{Figure 14.27: ResNet enabled dramatically deeper CNNs while reducing classification error.}
...
\begin{figure}[H]
    ...
    \caption{Figure 14.28: Example network architectures for ImageNet. Left: VGG-19. 
