...
\begin{document}
\lecture{9 (Extension)}{Regression IV: Performance Metrics}{Ghassan AlRegib and Mohit Prabhushankar}{}

\noindent\textbf{Keywords:} Regression, performance metrics, cross-validation, bias-variance tradeoff, model complexity
