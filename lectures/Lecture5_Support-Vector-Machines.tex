...
\lecture{4}{Classification III: Support Vector Machines}{Ghassan AlRegib and Mohit Prabhushankar}{}

%%%%%CHANGE HERE%%%%%%%
%%%%%\section{title of the section} similarly with the rest \section{} or \subsection{} or \subsubsection{} etc

\noindent\textbf{Keywords:} Support vectors, maximal margins, kernels, classification, optimization, decision boundaries
...
\begin{itemize}
    ...
    \begin{figure}[h]
        ...
        \caption{Figure 4.1: Sigmoid Function Plots showing the effect of weight (left) and bias (right).}
        \label{fig:sigmoid}
    \end{figure}
...
\begin{figure}[h!]
    ...
    \begin{minipage}{0.55\textwidth}
        \centering
        \includegraphics[width=\textwidth]{img/lecture4/tree_outlook.png}
        \caption{Figure 4.2: Final decision tree computed based on the dataset}
...
\begin{figure}[h]
    ...
    \caption{Figure 4.3: Separation of two-dimensional feature space by a hyperplane}
...
\begin{figure}[h]
    ...
    \caption{Figure 4.4: Multiple separating hyperplanes}
...
\begin{figure}[h]
    ...
    \caption{Figure 4.5: Maximal margin hyperplane along with its support vectors}
    \label{fig:mmh}
\end{figure}
...
\begin{figure}[h]
    ...
    \caption{Figure 4.6: Maximal margin classifier with margin width shown}
...
\begin{figure}
    ...
    \caption{Figure 4.7: Varying values of $C$ result in different margin widths}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\linewidth]{img/lecture4/nonlinearsoftmargin.png}
    \caption{Figure 4.8: Adding a new dimension allows a nonlinear dataset to become linearly separable}
    \label{fig:enter-label}
\end{figure}
...
Boser, Bernhard E., Guyon, Isabelle M., and Vapnik, Vladimir N. (1992). A Training Algorithm for Optimal Margin Classifiers. \textit{Proceedings of the Fifth Annual Workshop on Computational Learning Theory (COLT)}, 144--152.\\ \\
Cortes, Corinna and Vapnik, Vladimir (1995). Support-Vector Networks. \textit{Machine Learning}, 20(3), 273--297.
