...
\noindent\texttt{@article\{cortes1995support,}\\
\texttt{  title=\{Support-Vector Networks\},}\\
\texttt{  author=\{Cortes, Corinna and Vapnik, Vladimir\},}\\
\texttt{  journal=\{Machine Learning\},}\\
\texttt{  volume=\{20\},}\\
\texttt{  number=\{3\},}\\
\texttt{  pages=\{273--297\},}\\
\texttt{  year=\{1995\},}\\
\texttt{  publisher=\{Springer\}}\\
\texttt{\}}\\ \\
\texttt{@inproceedings\{boser1992training,}\\
\texttt{  title=\{A Training Algorithm for Optimal Margin Classifiers\},}\\
\texttt{  author=\{Boser, Bernhard E. and Guyon, Isabelle M. and Vapnik, Vladimir N.\},}\\
\texttt{  booktitle=\{Proceedings of the Fifth Annual Workshop on Computational Learning Theory (COLT)\},}\\
\texttt{  pages=\{144--152\},}\\
\texttt{  year=\{1992\},}\\
\texttt{  publisher=\{ACM\}}\\
\texttt{\}}
