...
\begin{figure}[H]
    ...
    \caption{Figure 25.1: Active learning process workflow.}
...
\begin{figure}[h]
    ...
    \caption{Figure 25.2: Comparison of acquisition strategies by performance}
...
\begin{figure}[h]
    ...
    \caption{Figure 25.3: Annotator effort metrics for different acquisition strategies}
...
\begin{figure}[H]
    ...
    \caption{Figure 25.4: Entropy Sampling Visualization}
...
\begin{figure}[H]
    ...
    \caption{Figure 25.5: Least Sampling Visualization}
...
\begin{figure}[h]
    ...
    \caption{Figure 25.6: Margin Sampling Visualization}
...
\begin{figure}[H]
    ...
    \caption{Figure 25.7: Core Set sampling illustration showing representative sample selection}
...
\begin{figure}[H]
    ...
    \caption{Figure 25.8: Discriminative sampling identifying underrepresented regions}
...
\begin{figure}[H]
    ...
    \caption{Figure 25.9: Fusion-based Active Learning Process combining diversity and difficulty criteria}
...
\begin{figure}[H]
    ...
    \caption{Figure 25.10: Example of performance regression in an autonomous driving scenario}
...
\begin{figure}[H]
    ...
    \caption{Figure 25.11: Regression manifested through negative flips}
...
\begin{figure}[H]
    ...
    \caption{Figure 25.12: Workflow for computing the Negative Flip Rate}
...
\begin{figure}[H]
    ...
    \caption{Figure 25.13: Negative Flip Rate comparison between CIFAR-10 and CIFAR-100}
