...
\lecture{17}{Autoencoders I: Convolutional Autoencoders}{Ghassan AlRegib and Mohit Prabhushankar}{}

%%%%%CHANGE HERE%%%%%%%
%%%%%\section{title of the section} similarly with the rest \section{} or \subsection{} or \subsubsection{} etc

\noindent\textbf{Keywords:} Autoencoders, latent representations, representation learning, unsupervised learning, neural networks
...
\begin{figure}[H]
    ...
    \caption{Figure 17.1: Autoencoder and Reconstruction}
...
\begin{figure}[H]
    ...
    \caption{Figure 17.2: \textbf{Illustration of PCA for dimensionality reduction.}
...
\begin{figure}[H]
    ...
    \caption{Figure 17.3: Linear AutoEncoders}
    \label{fig:enter-label}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Figure 17.4: Nonlinear Autoencoders}
    \label{fig:enter-label}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Figure 17.5: Fully-connected autoencoder encoder–decoder structure.}
...
\begin{figure}[H]
    ...
    \caption{Figure 17.6: Example fully-connected autoencoder architecture for MNIST.}
...
\begin{figure}[H]
    ...
    \caption{Figure 17.7: MNIST reconstructions using linear and nonlinear fully-connected autoencoders. Nonlinear models produce sharper reconstructions.}
...
\begin{figure}[H]
    ...
    \caption{Figure 17.10: Two-dimensional latent space learned by a fully-connected autoencoder.}
    \label{fig:2d-latent}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Figure 17.11: Overview of convolutional autoencoder architecture.}
...
\begin{figure}[H]
    ...
    \caption{Figure 17.12: Encoder and decoder structure in convolutional autoencoders.}
...
\begin{figure}[H]
    ...
    \caption{Figure 17.13: \textbf{Unpooling strategies.} 
...
\begin{figure}[H]
    ...
    \caption{Figure 17.14: Max-unpooling using stored pooling indices.}
...
\begin{figure}[H]
    ...
    \caption{Figure 17.15: Learnable upsampling using transposed convolution.}
...
\begin{figure}[H]
    ...
    \caption{Figure 17.16: \textbf{Convolutional autoencoder architecture for MNIST.} The encoder progressively reduces spatial resolution to form a compact latent representation, while the decoder reconstructs the image using transposed convolutions.}
...
\begin{figure}[H]
    ...
    \caption{Figure 17.17: \textbf{Original vs reconstructed MNIST images.} The autoencoder learns a compact representation that preserves the key structure of the digits.}
