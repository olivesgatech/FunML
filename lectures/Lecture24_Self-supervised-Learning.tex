...
\lecture{24}{Self-supervised Learning}{Ghassan AlRegib and Mohit Prabhushankar}{}
...
\begin{figure}[H]
    ...
    \caption{Figure 24.1: Comparison of supervised, unsupervised, and self-supervised learning pipelines and their sources of supervision.}
...
\begin{figure}[H]
    ...
    \caption{Figure 24.2: Pseudo-label generation using a pre-text task.}
...
\begin{figure}[H]
    ...
    \caption{Figure 24.3: Self-supervised pre-training using pseudo-labels.}
...
\begin{figure}[H]
    ...
    \caption{Figure 24.4: Fine-tuning the pre-trained model for downstream tasks.}
...
\begin{figure}[H]
    ...
    \caption{Figure 24.5: Transformation prediction using image rotations as pseudo-labels.}
...
\begin{figure}[H]
    ...
    \caption{Figure 24.7: Deep clustering for generating pseudo-labels from feature clusters.}
...
\begin{figure}[H]
    ...
    \caption{Figure 24.9: Overview of the SimCLR contrastive learning pipeline.}
    \label{fig:simclr_framework}
\end{figure}

\textbf{SimCLR} is a representative contrastive learning framework that learns visual representations by constructing \textbf{positive and negative pairs} within a training batch. As illustrated in Fig.~\ref{fig:simclr_framework}, the method consists of several key stages.
...
\begin{figure}[H]
    ...
    \caption{Figure 24.10: Performance comparison between contrastive and supervised learning models.}
    \label{fig:contrastive_vs_supervised}
\end{figure}

Recent empirical results demonstrate that large-scale \textbf{contrastive learning} can rival or even surpass traditional \textbf{supervised learning}. As shown in Fig.~\ref{fig:contrastive_vs_supervised}, models trained using self-supervision achieve competitive ImageNet accuracy while using fewer labeled examples.
...
\begin{figure}[H]
    ...
    \caption{Figure 24.11: Region-based contrastive learning in fisheye images.}
...
\begin{figure}[H]
    ...
    \caption{Figure 24.12: Alternative region partitioning strategies for fisheye images.}
...
\begin{figure}[H]
    ...
    \caption{Figure 24.13: Contrastive learning via volume partitioning in seismic data.}
...
\begin{figure}[H]
    ...
    \caption{Figure 24.14: Patient-based positive pair construction in medical imaging.}
...
\begin{figure}[H]
    ...
    \caption{Figure 24.15: Contrastive learning applications in text and audio modalities.}
...
Foundation models represent a major shift in modern machine learning. Instead of training task-specific models from scratch, large models are first trained on massive and diverse datasets using self-supervised objectives, and are later adapted to many downstream tasks. This paradigm connects directly to the self-supervised learning concepts discussed throughout this lecture.
...
\begin{figure}[H]
    ...
    \caption{Figure 24.16: Segment Anything Model (SAM): a large-scale foundation model for image segmentation.}
    \label{fig:sam}
\end{figure}

One prominent example of a modern foundation model is the \textbf{Segment Anything Model (SAM)}, released by Meta in April 2023. As shown in Fig.~\ref{fig:sam}, SAM was trained on an unprecedented dataset containing \textbf{1.1 billion segmentation masks} from \textbf{11 million images}. This scale enables the model to generalize across diverse visual domains and perform segmentation without task-specific training.
